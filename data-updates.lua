...
data:extend({{
    ...
    prerequisites = {"steel-processing", "processing-unit", "battery", "railway", "production-science-pack",
                     "utility-science-pack", "electric-engine"},
    unit = {
        count = 2000,
...
if mods["space-exploration"] or (mods["space-age"] and settings.startup["lock-behind-fulgora"].value == "false") then
    ...
    if mods["space-age"] then
        ...
        data.raw["technology"]["tech-electric-trains"].prerequisites = {"logistic-science-pack",
                                                                        "chemical-science-pack", "electric-engine"}
    else
        data.raw["technology"]["tech-electric-trains"].prerequisites = {"logistic-science-pack",
                                                                        "chemical-science-pack", "electric-engine"}
    end
    ...
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-alkaline-battery-pack"].prerequisites = {"logistic-science-pack",
    ...
    data.raw["technology"]["tech-electric-trains-experimental-charging"].unit.ingredients = {{"automation-science-pack",
                                                                                              1},
    ...
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-electric-trains-experimental-charging"].prerequisites = {"logistic-science-pack",
                                                                                          "chemical-science-pack",
                                                                                          "tech-electric-trains"}
    ...
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-acceleration-battery-pack"].prerequisites = {"logistic-science-pack",
                                                                              "chemical-science-pack",
                                                                              "tech-electric-trains",
                                                                              "tech-electric-trains-experimental-charging"}
    ...
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-efficiency-battery-pack"].prerequisites = {"logistic-science-pack",
                                                                            "chemical-science-pack",
                                                                            "tech-electric-trains",
                                                                            "tech-electric-trains-experimental-charging"}
...
elseif mods["space-age"] and settings.startup["lock-behind-fulgora"].value == "true" then
    ...
    data.raw["technology"]["tech-speed-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-speed-battery-pack"].prerequisites = {"tech-electric-trains",
                                                                       "tech-electric-trains-experimental-charging"}
    ...
    data.raw["technology"]["tech-acceleration-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-acceleration-battery-pack"].prerequisites = {"tech-electric-trains",
                                                                              "tech-electric-trains-experimental-charging"}
    ...
    data.raw["technology"]["tech-efficiency-battery-pack"].prerequisites = {}
    -- Add the new science prerequisites.
    data.raw["technology"]["tech-efficiency-battery-pack"].prerequisites = {"tech-electric-trains",
                                                                            "tech-electric-trains-experimental-charging"}
